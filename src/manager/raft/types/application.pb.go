...
type Slot struct {
	...
	CurrentTask          *Task          `protobuf:"bytes,8,opt,name=CurrentTask" json:"CurrentTask,omitempty"`
	TaskHistory          []string       `protobuf:"bytes,9,rep,name=TaskHistory" json:"TaskHistory,omitempty"`
...
type Task struct {
	...
	AppId         string   `protobuf:"bytes,3,opt,name=appId,proto3" json:"appId,omitempty"`
	VersionId     string   `protobuf:"bytes,4,opt,name=versionId,proto3" json:"versionId,omitempty"`
	SlotIndex     int32    `protobuf:"varint,5,opt,name=slotIndex,proto3" json:"slotIndex,omitempty"`
	...
	HostPorts     []uint64 `protobuf:"varint,9,rep,packed,name=hostPorts" json:"hostPorts,omitempty"`
...
var fileDescriptorApplication = []byte{
	...
	,
}
