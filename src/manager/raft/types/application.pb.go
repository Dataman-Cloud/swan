...
type Version struct {
	...
	Constraints  string            `protobuf:"bytes,14,opt,name=constraints,proto3" json:"constraints,omitempty"`
	Uris         []string          `protobuf:"bytes,15,rep,name=uris" json:"uris,omitempty"`
	Ip           []string          `protobuf:"bytes,16,rep,name=ip" json:"ip,omitempty"`
	Mode         string            `protobuf:"bytes,17,opt,name=mode,proto3" json:"mode,omitempty"`
	AppName      string            `protobuf:"bytes,18,opt,name=appName,proto3" json:"appName,omitempty"`
...
type Task struct {
	...
	ContainerId   string   `protobuf:"bytes,17,opt,name=containerId,proto3" json:"containerId,omitempty"`
...
func (m *StateMachine) Reset()                    { *m = StateMachine{} }
func (m *StateMachine) String() string            { return proto.CompactTextString(m) }
func (*StateMachine) ProtoMessage()               {}
func (*StateMachine) Descriptor() ([]byte, []int) { return fileDescriptorApplication, []int{14} }
...
func (*State) Descriptor() ([]byte, []int) { return fileDescriptorApplication, []int{15} }
...
func init() {
	...
	proto.RegisterType((*StateMachine)(nil), "types.StateMachine")
...
func (this *Application) VerboseEqual(that interface{}) error {
	...
	if !this.StateMachine.Equal(that1.StateMachine) {
		return fmt.Errorf("StateMachine this(%v) Not Equal that(%v)", this.StateMachine, that1.StateMachine)
	}
...
func (this *Version) VerboseEqual(that interface{}) error {
	...
	if this.AppName != that1.AppName {
		return fmt.Errorf("AppName this(%v) Not Equal that(%v)", this.AppName, that1.AppName)
	}
...
func (this *Task) VerboseEqual(that interface{}) error {
	...
	if this.ContainerName != that1.ContainerName {
		return fmt.Errorf("ContainerName this(%v) Not Equal that(%v)", this.ContainerName, that1.ContainerName)
	}
	if this.Weight != that1.Weight {
		return fmt.Errorf("Weight this(%v) Not Equal that(%v)", this.Weight, that1.Weight)
	}
...
func (this *StateMachine) VerboseEqual(that interface{}) error {
	...
	that1, ok := that.(*StateMachine)
	if !ok {
		that2, ok := that.(StateMachine)
		if ok {
			that1 = &that2
		} else {
			return fmt.Errorf("that is not of type *StateMachine")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *StateMachine but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *StateMachine but is not nil && this == nil")
	}
...
func (this *State) VerboseEqual(that interface{}) error {
	...
	if this.CurrentSlotIndex != that1.CurrentSlotIndex {
		return fmt.Errorf("CurrentSlotIndex this(%v) Not Equal that(%v)", this.CurrentSlotIndex, that1.CurrentSlotIndex)
	}
	if this.TargetSlotIndex != that1.TargetSlotIndex {
		return fmt.Errorf("TargetSlotIndex this(%v) Not Equal that(%v)", this.TargetSlotIndex, that1.TargetSlotIndex)
	}
	if this.SlotCountNeedUpdate != that1.SlotCountNeedUpdate {
		return fmt.Errorf("SlotCountNeedUpdate this(%v) Not Equal that(%v)", this.SlotCountNeedUpdate, that1.SlotCountNeedUpdate)
	}
	return nil
}
...
func (this *Application) GoString() string {
	...
	if this.StateMachine != nil {
		s = append(s, "StateMachine: "+fmt.Sprintf("%#v", this.StateMachine)+",\n")
	}
...
func (this *State) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&types.State{")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "CurrentSlotIndex: "+fmt.Sprintf("%#v", this.CurrentSlotIndex)+",\n")
	s = append(s, "TargetSlotIndex: "+fmt.Sprintf("%#v", this.TargetSlotIndex)+",\n")
	s = append(s, "SlotCountNeedUpdate: "+fmt.Sprintf("%#v", this.SlotCountNeedUpdate)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Application) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StateMachine != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintApplication(dAtA, i, uint64(m.StateMachine.Size()))
		n3, err := m.StateMachine.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *Version) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HealthCheck != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintApplication(dAtA, i, uint64(m.HealthCheck.Size()))
	...
	if m.KillPolicy != nil {
		...
		n6, err := m.KillPolicy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
	...
	if len(m.AppVersion) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintApplication(dAtA, i, uint64(len(m.AppVersion)))
...
func (m *Container) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Docker != nil {
		...
		n8, err := m.Docker.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *PortMapping) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HostPort != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintApplication(dAtA, i, uint64(m.HostPort))
	}
	if len(m.Name) > 0 {
		dAtA[i] = 0x1a
		i++
...
func (m *HealthCheck) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DelaySeconds != 0 {
		dAtA[i] = 0x69
		i++
		i = encodeFixed64Application(dAtA, i, uint64(math.Float64bits(float64(m.DelaySeconds))))
	}
	return i, nil
}
...
func (m *Slot) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CurrentTask != nil {
		...
		n9, err := m.CurrentTask.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
	...
	if m.RestartPolicy != nil {
		...
		n10, err := m.RestartPolicy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
	...
	if m.Weight != 0 {
		dAtA[i] = 0x59
		i++
		i = encodeFixed64Application(dAtA, i, uint64(math.Float64bits(float64(m.Weight))))
	}
	return i, nil
}
...
func (m *Task) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.HostPorts) > 0 {
		dAtA12 := make([]byte, len(m.HostPorts)*10)
		var j11 int
		...
		dAtA[i] = 0x42
		i++
		i = encodeVarintApplication(dAtA, i, uint64(j11))
	...
	if len(m.ContainerId) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintApplication(dAtA, i, uint64(len(m.ContainerId)))
	...
	if len(m.ContainerName) > 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintApplication(dAtA, i, uint64(len(m.ContainerName)))
...
func (m *OfferAllocatorItem) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Hostname) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintApplication(dAtA, i, uint64(len(m.Hostname)))
...
func (m *StateMachine) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.State != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintApplication(dAtA, i, uint64(m.State.Size()))
...
func (m *State) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CurrentSlotIndex != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintApplication(dAtA, i, uint64(m.CurrentSlotIndex))
	}
	if m.TargetSlotIndex != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintApplication(dAtA, i, uint64(m.TargetSlotIndex))
	}
	if m.SlotCountNeedUpdate != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintApplication(dAtA, i, uint64(m.SlotCountNeedUpdate))
	}
	return i, nil
}
...
func NewPopulatedApplication(r randyApplication, easy bool) *Application {
	...
	if r.Intn(10) != 0 {
		this.StateMachine = NewPopulatedStateMachine(r, easy)
	}
...
func NewPopulatedVersion(r randyApplication, easy bool) *Version {
	...
	this.AppName = string(randStringApplication(r))
	...
	this.AppVersion = string(randStringApplication(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedDocker(r randyApplication, easy bool) *Docker {
	...
	if r.Intn(10) != 0 {
		v7 := r.Intn(5)
		this.Parameters = make([]*Parameter, v7)
		for i := 0; i < v7; i++ {
	...
	if r.Intn(10) != 0 {
		v8 := r.Intn(5)
		this.PortMappings = make([]*PortMapping, v8)
		for i := 0; i < v8; i++ {
...
func NewPopulatedTask(r randyApplication, easy bool) *Task {
	...
	v9 := r.Intn(10)
	this.HostPorts = make([]uint64, v9)
	for i := 0; i < v9; i++ {
		this.HostPorts[i] = uint64(uint64(r.Uint32()))
	}
	this.OfferID = string(randStringApplication(r))
	this.AgentID = string(randStringApplication(r))
	this.Ip = string(randStringApplication(r))
	this.AgentHostName = string(randStringApplication(r))
	this.Reason = string(randStringApplication(r))
	this.Message = string(randStringApplication(r))
	this.CreatedAt = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.CreatedAt *= -1
	}
	...
	this.ContainerId = string(randStringApplication(r))
	this.ContainerName = string(randStringApplication(r))
	this.Weight = float64(r.Float64())
	if r.Intn(2) == 0 {
		this.Weight *= -1
	}
...
func NewPopulatedOfferAllocatorItem(r randyApplication, easy bool) *OfferAllocatorItem {
	...
	this.SlotID = string(randStringApplication(r))
	this.OfferID = string(randStringApplication(r))
	this.Hostname = string(randStringApplication(r))
	this.AgentID = string(randStringApplication(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedStateMachine(r randyApplication, easy bool) *StateMachine {
	this := &StateMachine{}
	if r.Intn(10) != 0 {
		this.State = NewPopulatedState(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedState(r randyApplication, easy bool) *State {
	this := &State{}
	this.Name = string(randStringApplication(r))
	this.CurrentSlotIndex = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.CurrentSlotIndex *= -1
	}
	this.TargetSlotIndex = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.TargetSlotIndex *= -1
	}
	this.SlotCountNeedUpdate = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.SlotCountNeedUpdate *= -1
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *PortMapping) Size() (n int) {
	...
	if m.HostPort != 0 {
		n += 1 + sovApplication(uint64(m.HostPort))
	}
	l = len(m.Name)
	if l > 0 {
		n += 1 + l + sovApplication(uint64(l))
...
func (m *State) Size() (n int) {
	...
	if m.CurrentSlotIndex != 0 {
		n += 1 + sovApplication(uint64(m.CurrentSlotIndex))
	}
	if m.TargetSlotIndex != 0 {
		n += 1 + sovApplication(uint64(m.TargetSlotIndex))
	}
	if m.SlotCountNeedUpdate != 0 {
		n += 1 + sovApplication(uint64(m.SlotCountNeedUpdate))
	}
	return n
}
...
func (m *StateMachine) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StateMachine: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StateMachine: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentSlotIndex", wireType)
			}
			m.CurrentSlotIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApplication
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CurrentSlotIndex |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetSlotIndex", wireType)
			}
			m.TargetSlotIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetSlotIndex |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlotCountNeedUpdate", wireType)
			}
			m.SlotCountNeedUpdate = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApplication
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SlotCountNeedUpdate |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApplication = []byte{
	...
	,
}
