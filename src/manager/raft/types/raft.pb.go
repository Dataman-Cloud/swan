...
type StoreAction_OfferAllocatorItem struct {
	OfferAllocatorItem *OfferAllocatorItem `protobuf:"bytes,7,opt,name=offer_allocator_item,json=offerAllocatorItem,oneof"`
}
...
func _StoreAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 6: // target.task
		...
		return true, err
	case 7: // target.offer_allocator_item
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
var fileDescriptorRaft = []byte{
	...
	,
}
