...
func (this *Node) VerboseEqual(that interface{}) error {
	...
	if this.RaftListenAddr != that1.RaftListenAddr {
		return fmt.Errorf("RaftListenAddr this(%v) Not Equal that(%v)", this.RaftListenAddr, that1.RaftListenAddr)
	}
	if this.RaftAdvertiseAddr != that1.RaftAdvertiseAddr {
		return fmt.Errorf("RaftAdvertiseAddr this(%v) Not Equal that(%v)", this.RaftAdvertiseAddr, that1.RaftAdvertiseAddr)
	}
...
func (this *Node) GoString() string {
	...
	s = append(s, "RaftListenAddr: "+fmt.Sprintf("%#v", this.RaftListenAddr)+",\n")
	s = append(s, "RaftAdvertiseAddr: "+fmt.Sprintf("%#v", this.RaftAdvertiseAddr)+",\n")
...
func (m *Node) MarshalTo(data []byte) (int, error) {
	...
	if len(m.RaftListenAddr) > 0 {
		data[i] = 0x22
		i++
		i = encodeVarintRaft(data, i, uint64(len(m.RaftListenAddr)))
		i += copy(data[i:], m.RaftListenAddr)
	}
	if len(m.RaftAdvertiseAddr) > 0 {
		data[i] = 0x2a
		i++
		i = encodeVarintRaft(data, i, uint64(len(m.RaftAdvertiseAddr)))
		i += copy(data[i:], m.RaftAdvertiseAddr)
	}
	if len(m.Status) > 0 {
		data[i] = 0x32
		i++
...
func NewPopulatedNode(r randyRaft, easy bool) *Node {
	this := &Node{}
	this.ID = randStringRaft(r)
	this.AdvertiseAddr = randStringRaft(r)
	this.ListenAddr = randStringRaft(r)
	this.RaftListenAddr = randStringRaft(r)
	this.RaftAdvertiseAddr = randStringRaft(r)
	this.Status = randStringRaft(r)
	if r.Intn(10) != 0 {
		v2 := r.Intn(10)
...
func (m *Node) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RaftAdvertiseAddr", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RaftAdvertiseAddr = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
...
var fileDescriptorRaft = []byte{
	...
	,
}
