...
type Task struct {
	...
	ForcePullImage bool              `protobuf:"varint,10,opt,name=forcePullImage,proto3" json:"forcePullImage,omitempty"`
	PortMappings   []*PortMappings   `protobuf:"bytes,11,rep,name=portMappings" json:"portMappings,omitempty"`
	Parameters     []*Parameter      `protobuf:"bytes,12,rep,name=parameters" json:"parameters,omitempty"`
...
type PortMappings struct {
	Port     uint32 `protobuf:"fixed32,1,opt,name=port,proto3" json:"port,omitempty"`
...
func (m *PortMappings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Port != 0 {
		dAtA[i] = 0xd
		i++
		i = encodeFixed32Task(dAtA, i, uint32(m.Port))
	}
	if len(m.Protocol) > 0 {
		dAtA[i] = 0x12
		i++
...
func (m *PortMappings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			iNdEx += 4
			m.Port = uint32(dAtA[iNdEx-4])
			m.Port |= uint32(dAtA[iNdEx-3]) << 8
			m.Port |= uint32(dAtA[iNdEx-2]) << 16
			m.Port |= uint32(dAtA[iNdEx-1]) << 24
		case 2:
			if wireType != 2 {
...
var fileDescriptorTask = []byte{
	...
	,
}
